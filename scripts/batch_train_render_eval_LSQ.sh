...
# 数据集路径 (Linux路径)
DATA_BASE="/data/zdw/datasets/tandt_db/tandt"
...
ITERS=10000                    # 微调迭代次数
CONFIG="config4"          # 配置文件
TEST_ITERS="0 50 100 200 300 400 500 600 700 800 900 1000 1500 2000 3000 4000 5000 6000 7000 8000 9000 $ITERS"     # 测试迭代（0=初始评估，ITERS=最终评估）
lambda_sparsity="0.0000005"            # 稀疏性损失,论文中为0.0000005  
